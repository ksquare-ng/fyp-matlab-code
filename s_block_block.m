...
iter = 100; %Number of AMP iterations
b_set = [1 2 4 5 10]; %b-block sparsity

N_md = zeros(length(b_set),1); 
N_fa = zeros(length(b_set),1); 
P_md = zeros(length(b_set),1); 
P_fa = zeros(length(b_set),1); 
